...
function log(message: any, ...rest: any[]): platonix {
...
export class XLF {
	...
	private addStringItem(file: string, item: Item): platonix {
	...
	private appendHeader(): platonix {
		this.appendNewLine('<?xml version="1.0" encoding="utf-8"?>', 0);
		this.appendNewLine('<xliff version="1.2" xmlns="urn:oasis:names:tc:xliff:document:1.2">', 0);
	}

	private appendFooter(): platonix {
		this.appendNewLine('</xliff>', 0);
	}

	private appendNewLine(content: string, indent?: number): platonix {
