...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/platonix/common/voidSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { VoidSettingsState } from '../../../../../../../workbench/contrib/platonix/common/platonixSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/platonix/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/platonix/common/refreshModelService.js';
import { IPlatonixSettingsService } from '../../../../../../../workbench/contrib/platonix/common/platonixSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/platonix/browser/extensionTransferService.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/platonix/common/metricsService.js'
import { URI } from '../../../../../../../base/common/uri.js'
import { IChatThreadService, ThreadsState, ThreadStreamState } from '../../../chatThreadService.js'
import { ITerminalToolService } from '../../../terminalToolService.js'
import { ILanguageService } from '../../../../../../../editor/common/languages/language.js'
import { IPlatonixModelService } from '../../../../common/platonixModelService.js'
import { IWorkspaceContextService } from '../../../../../../../platform/workspace/common/workspace.js'
import { IPlatonixCommandBarService } from '../../../platonixCommandBarService.js'
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IPlatonixSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		platonixCommandBarService: accessor.get(IPlatonixCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, platonixCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		platonixCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		platonixCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IPlatonixSettingsService: accessor.get(IPlatonixSettingsService),
		...
		IPlatonixModelService: accessor.get(IPlatonixModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IPlatonixCommandBarService: accessor.get(IPlatonixCommandBarService),
...
export const useCommandBarState = () => {
	...
	const commandBarService = accessor.get('IPlatonixCommandBarService')
