...
import { PlatonixSelectionHelperProps } from '../../../../../../contrib/platonix/browser/voidSelectionHelperWidget.js';
import { VOID_OPEN_SETTINGS_ACTION_ID } from '../../../voidSettingsPane.js';


export const PlatonixSelectionHelperMain = (props: PlatonixSelectionHelperProps) => {
	...
	>
		<PlatonixSelectionHelper {...props} />
	</div>
}



const PlatonixSelectionHelper = ({ rerenderKey }: PlatonixSelectionHelperProps) => {
	...
	const dividerHTML = <div className='w-[0.5px] bg-platonix-border-3'></div>
	...
	return <div className='
		...
		border border-platonix-border-3 bg-platonix-bg-2
