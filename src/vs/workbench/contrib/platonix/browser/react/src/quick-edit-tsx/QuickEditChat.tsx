...
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/platonix/common/voidSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const loadingIcon = <div
		className="@@codicon @@codicon-loading @@codicon-modifier-spin @@codicon-no-default-spin text-platonix-fg-3"
	/>
