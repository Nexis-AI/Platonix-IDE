...
import { PlatonixCommandBarProps } from '../../../platonixCommandBarService.js';
...
export const PlatonixCommandBarMain = ({ uri, editor }: PlatonixCommandBarProps) => {
	const isDark = useIsDark()

	return <div
		className={`@@platonix-scope ${isDark ? 'dark' : ''}`}
	>
		<PlatonixCommandBar uri={uri} editor={editor} />
	</div>
}
...
export const PlatonixCommandBar = ({ uri, editor }: PlatonixCommandBarProps) => {
	...
	const platonixModelService = accessor.get('IPlatonixModelService')
	...
	if (currFileIdx === null) {
		return (
			<div className="pointer-events-auto">
				<div className="flex bg-platonix-bg-2 shadow-md border border-platonix-border-2 [&>*:first-child]:pl-3 [&>*:last-child]:pr-3 [&>*]:border-r [&>*]:border-platonix-border-2 [&>*:last-child]:border-r-0">
		...
		<div className="pointer-events-auto">
			...
			{showAcceptRejectAllButtons && showAcceptRejectAll && (
				<div className="flex justify-end mb-1">
					<div className="inline-flex bg-platonix-bg-2 rounded shadow-md border border-platonix-border-2 overflow-hidden">
						<div className="flex items-center [&>*]:border-r [&>*]:border-platonix-border-2 [&>*:last-child]:border-r-0">
			...
			<div className="flex items-center bg-platonix-bg-2 rounded shadow-md border border-platonix-border-2 [&>*:first-child]:pl-3 [&>*:last-child]:pr-3 [&>*]:px-3 [&>*]:border-r [&>*]:border-platonix-border-2 [&>*:last-child]:border-r-0">
