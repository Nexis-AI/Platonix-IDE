...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@IPlatonixModelService platonixModelService: IPlatonixModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@IPlatonixCommandBarService private readonly commandBarService: IPlatonixCommandBarService,
		...
		this.callTool = {
			read_file: async ({ uri, startLine, endLine, pageNumber }) => {
				await platonixModelService.initializeModel(uri)
				const { model } = await platonixModelService.getModelSafe(uri)
		...
		this.stringOfResult = {
			...
			search_in_file: (params, result) => {
				const { model } = platonixModelService.getModel(params.uri)
			...
			edit_file: (params, result) => {
				const lintErrsString = (
					this.platonixSettingsService.state.globalSettings.includeToolLintErrors ?
