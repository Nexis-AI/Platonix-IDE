...
// const voidViewIcon = registerIcon('platonix-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the Void chat view.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "Platonix" (Ctrl + L)
