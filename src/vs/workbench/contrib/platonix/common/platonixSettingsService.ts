...
export interface IPlatonixSettingsService {
...
export const IPlatonixSettingsService = createDecorator<IPlatonixSettingsService>('PlatonixSettingsService');
class PlatonixSettingsService extends Disposable implements IPlatonixSettingsService {
...
registerSingleton(IPlatonixSettingsService, PlatonixSettingsService, InstantiationType.Eager);
