...
export interface IPlatonixModelService {
...
export const IPlatonixModelService = createDecorator<IPlatonixModelService>('voidPlatonixModelService');

class PlatonixModelService extends Disposable implements IPlatonixModelService {
	_serviceBrand: undefined;
	static readonly ID = 'voidPlatonixModelService';
...
registerSingleton(IPlatonixModelService, PlatonixModelService, InstantiationType.Eager);
